...
export const StorageKeys = {
  ...
  FAVORITES: 'FAVORITES',
  DEVOTIONAL_FAVORITES: 'DEVOTIONAL_FAVORITES',
  HOME_TOUR_DONE: 'HOME_TOUR_DONE',
  LIVING_WATERS_TOUR_DONE: 'LIVING_WATERS_TOUR_DONE',
  AUDIO_PLAYER_TOUR_DONE: 'AUDIO_PLAYER_TOUR_DONE',
  ONESOUND_LYRICS_TOUR_DONE: 'ONESOUND_LYRICS_TOUR_DONE',
